    ...
    <div class="main-panel">
       ...
       <div class="content-wrapper">
           <div class="content container">
            ...
            <div class="row"><a href="#" class="btn btn-success" style="margin-left: 25px; margin-bottom: 0px; margin-top: 10px">Graphic</a><a href="routing_comp.php" class="btn btn-success" style="margin-left: 25px; margin-bottom: 0px; margin-top: 10px">Component</a></div>
